...
let
  ...
  importedJson = lib.importJSON inputs.catppuccin-stylus.outPath;
  catp-stylus-util = (import ./util/catppuccin-userstyles.nix) lib importedJson;
in
{
      ...
      profiles.dev-edition-default = {
        extensions = {
          ...
          settings = {
            ...
            # Stylus
            "{7a7a4a92-a2a0-41d1-9fd7-1e92480d612d}".settings = catp-stylus-util {
